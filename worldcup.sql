...
--
-- Name: idx_games_winner_id; Type: INDEX; Schema: public; Owner: freecodecamp
--

CREATE INDEX idx_games_winner_id ON public.games USING btree (winner_id);


--
-- Name: idx_teams_name; Type: INDEX; Schema: public; Owner: freecodecamp
--
